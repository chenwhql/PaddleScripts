...
# out.backward(torch.tensor([1j, 1j, 1j]))
out.backward(torch.ones((2, 4), dtype=torch.complex64))
# out.backward(torch.tensor([[1j, 1j, 1j, 1j], [1j, 1j, 1j, 1j]], dtype=torch.complex64))
