...
for is_sparse in [False, True]:
    ...
    if not np.array_equal(static_last_cell_value, dy_last_cell_value):
        print(static_last_cell_value)
        print(dy_last_cell_value)
    if not np.array_equal(static_last_hidden_value, dy_last_hidden_value):
        print(static_last_hidden_value)
        print(dy_last_hidden_value)   
